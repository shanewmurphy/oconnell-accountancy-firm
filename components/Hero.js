  ...
  return (
    <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col justify-between mt-12 lg:mb-60 md:mb-40 sm:mb-36 gap-14">
      <div className="xl:basis-8/12 lg:basis-6/12 md:basis-8/12">
        <h1 className="xl:text-5xl lg:text-4xl md:text-5xl sm:text-3xl text-beige font-bold leading-relaxed antialiased lg:mb-3 md:mb-4 sm:mb-4">
          Maximise Your Financial Potential with Expert Accounting and Tax
          Consulting
        </h1>
        <h2 className="xl:text-3xl lg:text-2xl md:text-3xl sm:text-xl xl:w-9/12  text-white font-semibold leading-relaxed antialiased md:mb-12">
          Get Expert Tax Advice from the Comfort of Your Own Home
        </h2>
        <div className="mt-8">
          <button className="bg-beige hover:bg-transparent hover:text-beige hover:outline hover:outline-1 lg:px-16 lg:py-5 md:px-16 md:py-5 sm:px-9 sm:py-4 rounded-full lg:text-2xl md:text-2xl sm:text-lg text-green font-bold antialiased">
